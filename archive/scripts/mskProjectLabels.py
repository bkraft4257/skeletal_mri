...
if __name__ == "__main__":
     ...
     if  inArgs.run:
         ...
         if  iwQa.qa_input_files( input_files, False):
             ...
             iwUtilities.iw_subprocess([ 'gunzip', inArgs.labels ], inArgs.verbose, inArgs.debug, inArgs.nohup)
             iwUtilities.iw_subprocess([ 'gunzip', inArgs.t2w    ], inArgs.verbose, inArgs.debug, inArgs.nohup)
             ...
             try:
                 ...
                 iwUtilities.iw_subprocess(['gzip', os.path.splitext(inArgs.labels)[0], os.path.splitext(inArgs.t2w)[0] ], inArgs.verbose, inArgs.debug, inArgs.nohup)


             iwUtilities.iw_subprocess(['gzip', 'project.' + os.path.splitext(inArgs.labels)[0], 
     ...
     if  inArgs.qo:
          iwQa.freeview( output_files, True, True )    
