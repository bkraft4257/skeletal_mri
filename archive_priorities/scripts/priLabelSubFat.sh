...
fslmaths       subfat.step1.${inT2wFileName} -add perimeter.${inT2wFileName}  -bin \
               -kernel boxv 3    -dilF -ero  subfat.step2.${inT2wFileName}
fslmaths       subfat.step2.${inT2wFileName}                   -kernel boxv 3    -ero  -dilF subfat.step3.${inT2wFileName}

fslmaths       subfat.step3.${inT2wFileName} -add perimeter.${inT2wFileName}  -bin subfat.${inT2wFileName}
...
fslmaths subfat.${inT2wFileName}        -mul  1 calfLabels.nii.gz
fslmaths mask.${inT2wFileName}  -sub subfat.${inT2wFileName}  -mul 2 calfLabels.nii.gz
