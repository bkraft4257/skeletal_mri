...
#  then
    ...
    SYNCONVERGENCE="[200x200x200x70x50x0,1e-5,10]"
    SYNSHRINKFACTORS="16x10x6x4x2x1"
    SYNSMOOTHINGSIGMAS="8x5x3x2x1x0vox"
#  fi
...
if [[ $TRANSFORMTYPE == 'sr' ]] || [[ $TRANSFORMTYPE == 'br' ]];
  then
    SYNCONVERGENCE="[50x0,1e-5,10]"
    SYNSHRINKFACTORS="16x8x4x2x1x0"
