...
# Open operation
#fslmaths       tibiaMarrow.step3.${inT2wFileName} -kernel boxv 5 -dilM -bin     tibiaMarrow.step4.${inT2wFileName}
...
# fslmaths  step1.perimeter.tibiaMarrow.${inT2wFileName} -sub tibiaMarrow.step5.${inT2wFileName} step2.perimeter.tibiaMarrow.${inT2wFileName}
fi
...
fslmaths       tibiaMarrow.step5.${inT2wFileName}  -add tibiaCortex.${inT1wFileName} -bin tibiaMarrow.step6.${inT2wFileName}

# Close any gaps that my have existed.
fslmaths       tibiaMarrow.step6.${inT2wFileName}  -kernel boxv 3 -dilM -ero       tibiaMarrow.step7.${inT2wFileName}
